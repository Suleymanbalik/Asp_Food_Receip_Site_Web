<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="CategoryDetail.aspx.cs" Inherits="Asp_Food_Receip_Site_Web.CategoryDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <ItemTemplate>
        <table class="auto-style3">
            <tr>
                <td style="background-color: #60D285"><a href="FoodDetail.aspx?FoodID=<%# Eval("FoodID") %>">
            ...
            <tr>
                <td><strong>Upload Date :</strong>
                    ...
                    <asp:Label ID="Label8" runat="server" Text='<%# Eval("FoodCategoriID") %>'></asp:Label>
                </td>
            </tr>
        </table>
    </ItemTemplate>
